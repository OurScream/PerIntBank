...
<ul id="subNews" class="second-menu">
  ...
  <%
	 ...
	 %>
		 	...
		 	<tr>
		 	<td><font color="black"><%= p3.getZjid() %></font></td>
		 	<td><font color="black"><%= p3.getKhdlmm() %></font></td>
		 	<td><font color="black"><%= p3.getKhxm() %></font></td>
		 	<td><font color="black"><%= p3.getCsrq() %></font></td>
		 	<td><font color="black"><%= p3.getHyzk() %></font></td>
		    <td><font color="black"><%= p3.getSsmz() %></font></td>
		    <td><font color="black"><%= p3.getZjlx() %></font></td>
		    <td><font color="black"><%= p3.getZjqsrq() %></font></td>
		    <td><font color="black"><%= p3.getZjjzrq() %></font></td>
		    <td><font color="black"><%= p3.getKhxb() %></font></td>
		    <td><font color="black"><%= p3.getKhgj() %></font></td>
		    <td><font color="black"><%= p3.getYddh() %></font></td>
		    <td><font color="black"><%= p3.getGddh() %></font></td>
		    <td><font color="black"><%= p3.getJtdz() %></font></td>
		    <td><font color="black"><%= p3.getJtyb() %></font></td>
